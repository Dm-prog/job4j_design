...
public class Food {
    ...
    public double getLivedTimePercent() {
        double lifeTime = getExpiryDate().getTimeInMillis() - getCreateDate().getTimeInMillis();
        double livedTime = new GregorianCalendar().getTimeInMillis() - getCreateDate().getTimeInMillis();
